...
import { Plus, ExternalLink, Trash2, Search, Inbox, Link2 } from "lucide-react";
...
export default function App() {
  ...
  function handleRecategorize(id, category) {
    persist(links.map((l) => (l.id === id ? { ...l, category } : l)));
  }
        ...
        >
          ...
          {saveError && (
            <div style={{ color: "#D24B4B", fontSize: 13, marginTop: 8 }}>
              บันทึกไม่สำเร็จ — เบราว์เซอร์อาจปิดการใช้ localStorage หรือพื้นที่เต็ม
            </div>
          )}
        </form>
